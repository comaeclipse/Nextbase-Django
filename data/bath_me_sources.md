...
- LGBTQ: MAP's Maine Equality Profile reports Sexual Orientation Policy Score 21/23, Gender Identity Policy Score 23.5/26, and Overall Score 44.5/49. No current HRC Municipal Equality Index score for Bath was found, so `LGBTQ_MEI` is recorded as `Not Rated`.
...
- Retail access: `HasWalmart = N` (no Walmart store within Bath city limits; nearest Walmart Supercenter #2229 is in Brunswick, ME, ~8 mi away). `HasCostco = N` (no Costco warehouse within Bath city limits; Maine's sole Costco warehouse is in Scarborough, ME).
