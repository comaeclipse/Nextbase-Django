...
City-level 2016/2024 general-election returns and trend, local politics classification, crime grade, and municipal LGBTQ score remain blank pending source-backed research. The attachment's 58-point LGBTQ figure is explicitly analytical, not an HRC Municipal Equality Index score, so it was not written as a municipal rating. No values were inferred from county, state, or nearby-city data.
