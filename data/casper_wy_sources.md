...
- Climate: NOAA 1991-2020 normals for Casper/Natrona County International Airport (USW00024089) give annual precipitation 12.22 inches, annual snowfall 71.80 inches, January low 15.0 F, and July high 89.0 F, stored as 12, 72, 15, and 89. Current Results reports 107 fully sunny days plus 111 partly sunny days annually, so `sun_days` is stored as 218 days with some sun, not as 218 cloudless days. Summer humidity remains blank because the official normals do not provide a comparable measure. The snowfall drives the repository category `cold_snowy`.
- Air quality: the city and climate pages use the existing EPA AirData annual Natrona County summary for their year-by-year air-quality panel. The accompanying Casper narrative notes that wildfire smoke, ozone, and windblown dust can still produce individual-day spikes; it does not treat annual county AQI summaries as an exact municipal-boundary or daily forecast measure.
...
- Current Results annual sunshine, Wyoming: https://www.currentresults.com/Weather/Wyoming/annual-days-of-sunshine.php
