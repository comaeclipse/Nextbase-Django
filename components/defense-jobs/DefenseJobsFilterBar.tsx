...
/** The "More" section: remote-only + the aggregate cross-reference employers. */
    ...
    <div className="space-y-7 px-1 py-2">
      <section className="space-y-3">
        <SectionHeading
          ...
          description="Limit to listings that are fully remote."
        />
...
export default function DefenseJobsFilterBar({
  ...
  const moreCount =
    (remoteOnly ? 1 : 0) + selCountEmployers.size;
  ...
  // Active chips: one per selection, plus a remote chip.
            ...
            <Drawer direction="right">
              ...
              <DrawerContent className="rounded-none">
                <DrawerHeader className="border-b">
                  ...
                  <DrawerDescription>
                    Work arrangement and map cross-reference.
                  </DrawerDescription>
                </DrawerHeader>
